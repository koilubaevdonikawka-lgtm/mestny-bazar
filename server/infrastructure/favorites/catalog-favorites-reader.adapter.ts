...
/** Adapts Catalog Management to ICatalogFavoritesReader — no Product BCM access. */
export class CatalogFavoritesReaderAdapter implements ICatalogFavoritesReader {
