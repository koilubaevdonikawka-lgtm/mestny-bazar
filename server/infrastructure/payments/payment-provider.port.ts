...
/** Request to initiate a provider payment. */
...
/** Normalized provider payment response. */
...
/** Infrastructure payment port — implementations are provider-specific adapters. */
export interface IPaymentProvider {
  ...
  refundPayment(providerPaymentId: string, amount?: number, reason?: string): Promise<PaymentResponse>;
