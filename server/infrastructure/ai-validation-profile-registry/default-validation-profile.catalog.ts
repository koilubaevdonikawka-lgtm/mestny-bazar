...
/** Default in-memory validation profile catalog index. */
export class DefaultValidationProfileCatalog implements IValidationProfileCatalog {
  ...
  async register(validationProfile: ValidationProfile): Promise<void> {
  ...
  async remove(validationProfileId: string): Promise<void> {
    const validationProfile = this.validationProfiles.get(validationProfileId.trim());
  ...
  async listAll(): Promise<readonly ValidationProfile[]> {
